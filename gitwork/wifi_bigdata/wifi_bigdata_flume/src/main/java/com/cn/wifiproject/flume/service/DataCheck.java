package com.cn.wifiproject.flume.service;


import com.alibaba.fastjson.JSON;
import com.cn.wifiproject.common.net.HttpRequest;
import com.cn.wifiproject.common.project.datatype.DataTypeProperties;
import com.cn.wifiproject.common.time.TimeTranstationUtils;
import com.cn.wifiproject.flume.fields.ErrorMapFields;
...
public class DataCheck {
        ...
        if (dataMap.containsKey(dataType)) {
           ...
           // imei,imsi,longitude,latitude,phone_mac,device_mac,device_number,collect_time,username,phone,object_username,send_message,accept_message,message_time
            ...
            if (fields.size() == splits.length) {
                ...
                //数据封装完成  开始进行数据校验,如果有错误数据返回errorMap
    ...
    public static void addErrorMapESByHTTP(Map<String, Object> errorMap, Map<String, String> map, String fileName, String absoluteFilename) {
        ...
        String url="http://hadoop-4:9200/error_recourd/error_recourd/"+ errorMap.get(MapFields.ID).toString();
